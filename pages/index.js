...
export default function PageHome() {
  ...
  return (
    ...
    <ClientSide>
      ...
      <div className="flex flex-col items-center justify-center w-screen min-h-screen bg-gray-800 text-white-300 md:p-10">
        <div className="flex flex-col flex-grow w-full max-w-xl bg-white shadow-xl rounded-lg overflow-hidden">
              ...
              <div className="flex items-center space-x-4">
                ...
                <div className="flex flex-col leading-tight">
                  <div className="mt-1 flex items-center">
                    <span className="text-gray-700 mr-3">Chat EK OpenAI</span>
                  </div>
                  <span className="text-sm text-gray-600">
                    {loading ? "Typing..." : "Connect"}
                  </span>
                </div>
              </div>
          ...
          {/* chats */}
          <div className="flex flex-col flex-grow h-0 p-4 bg-gray-600 overflow-auto py-20 md:py-10">
            <>
              {chats?.length === 0 && (
                <div
                    ...
                    <Fragment key={index}>
                      ...
                      <div className="flex w-full mt-2 space-x-3 max-w-xs">
                        ...
                        <div>
                          ...
                          <span className="text-xs text-green-500 leading-none">
                            {formatDate(item.date)}
                          </span>
                        </div>
                      </div>
          ...
          {/* input chat */}
          <div className="bg-gray-500 shadow border-t p-2 fixed bottom-0 w-full max-w-xl">
            <div className="relative">
